...
richtungen = [
    ...
    {
        'nr': 3, 'name': 'Plakat', 'stamm': 'Plakat',
        'these': 'Der SONNENBERG zeigt Haltung: grosse Farbfelder in den Hausfarben, kräftige Typografie, klare Botschaften.',
        'motivation': 'Gelb, Petrol und Nachtblau tragen die Seiten wie ein Schulhausplakat – unverwechselbar, mutig und bis aufs Handy sofort erkennbar. Dicke Linien gliedern die Inhalte, jede Seite hat eine klare Botschaft.',
        'preis': 'Der laute Auftritt verlangt Disziplin im Inhalt: Lange Texte passen schlecht in Farbfelder. Die am wenigsten behördlich wirkende Richtung.',
        'dateien': ['Plakat', 'Plakat-Angebote', 'Plakat-Angebot', 'Plakat-Aufnahme', 'Plakat-Behoerden', 'Plakat-Aktuell', 'Plakat-Beitrag', 'Plakat-Ueberuns'],
        'favorit': False,
    },
    {
        'nr': 4, 'name': 'Wegweiser', 'stamm': 'Wegweiser',
        'these': 'Die Webseite als Nachschlagewerk: Ein ständiges Register links führt zu jeder Auskunft in einem Klick.',
        'motivation': 'Nichts liegt mehr als eine Ebene tief. Die Inhalte sind kompakt gesetzt wie in einem gut geführten Handbuch – ideal für Behörden und alle, die regelmässig dasselbe nachschlagen.',
        'preis': 'Wirkt sachlich-verwaltungsnah und zeigt wenig vom Leben im Haus; auf dem Handy wird aus dem Register ein aufklappbares Menü.',
        'dateien': ['Wegweiser', 'Wegweiser-Angebote', 'Wegweiser-Angebot', 'Wegweiser-Aufnahme', 'Wegweiser-Behoerden', 'Wegweiser-Aktuell', 'Wegweiser-Beitrag', 'Wegweiser-Ueberuns'],
        'favorit': False,
    },
    {
        'nr': 5, 'name': 'Magazin', 'stamm': 'Magazin',
        'these': 'Die Webseite als Hauszeitschrift: Serifenschrift, Zeitungskopf, Spalten und Bildlegenden.',
        'motivation': 'Erzählt mit der Sorgfalt des gedruckten SONNENBERG-Magazins – Initialen, römische Ziffern, kursive Legenden. Die ruhigste Richtung, sie schafft Vertrauen durch Ton und Haltung.',
        'preis': 'Leiser Auftritt: Handlungen wie Anmelden oder Kontakt treten hinter das Lesen zurück. Lebt von gepflegten Texten.',
        'dateien': ['Magazin', 'Magazin-Angebote', 'Magazin-Angebot', 'Magazin-Aufnahme', 'Magazin-Behoerden', 'Magazin-Aktuell', 'Magazin-Beitrag', 'Magazin-Ueberuns'],
        'favorit': False,
    },
]
...
vergleich = [
    ...
    ('3 · Plakat', 'Farbfelder und kräftige Typografie zeigen Haltung', 'Eltern und Öffentlichkeit', 'Wenig Platz für lange Inhalte', 'gering'),
    ('4 · Wegweiser', 'Ständiges Register: jede Auskunft in einem Klick', 'Gemeinden, Kanton, wiederkehrende Besucher', 'Sachlich, wenig Emotion', 'gering'),
    ('5 · Magazin', 'Die Seite als Hauszeitschrift mit ruhigen Spalten', 'Eltern und Freunde des Hauses', 'Leise – Handlungen treten zurück', 'mittel bis hoch'),
]
